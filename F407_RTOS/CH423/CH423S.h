...
// 对外子程序
extern void          CH423_WriteByte(I2C_HandleTypeDef *hi2c, unsigned short cmd );   // 写出数据
extern unsigned char CH423_ReadByte(I2C_HandleTypeDef *hi2c);    // 读取数据
...
uint8_t CH423_READ_2KEY(void);

//数话同传服务函数
void CH423_WRITE20LED(uint32_t LED);
uint8_t CH423_READ1KEY(void);
