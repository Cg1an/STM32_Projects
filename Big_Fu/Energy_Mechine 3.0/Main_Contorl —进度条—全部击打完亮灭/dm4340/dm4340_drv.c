...
/**
************************************************************************
* @brief:      	dm4310_enable: 启用DM4340电机控制模式函数
...
************************************************************************
**/
//MAN_A\MAN_A.axf: Error: L6218E: Undefined symbol motor3 (referred from arm_final_task.o).
...
************************************************************************
**/
float uint_to_float(int x_int, float x_min, float x_max, int bits)//32
{
...
void lock_motor(CAN_HandleTypeDef* hcan,uint16_t id)
{
	...
	canx_send_data(hcan,id,DATA_TX,8);
}	
