...
int main(void)
{
    ...
    //Board_Order_info[BOARD_NUMBER].count_t = 6;
    ...
    while (1)
    {
        ...
        if (!Board_Order_info[BOARD_NUMBER].RainBow_Flag) //²»ÎªÁ÷Ë®Ð§¹û
        {
            ...
            {
                if (Board_Order_info[BOARD_NUMBER].count_t == 0)
                {
                    WS_WriteAll_RGB_FRAME_DOWN(0, 0, 0);
                    WS_WriteAll_RGB_REC(0, 0, 0);
                    WS_WriteAll_RGB_FRAME_UP(0, 0, 0);
                ...
                else if (Board_Order_info[BOARD_NUMBER].count_t == 6)
                {
//                    LED_rectangle_current_REC(0, RED_NUM, 0, 0);	//ÏÔÊ¾½ø¶ÈÌõ
//                    WS_WriteAll_RGB_FRAME_DOWN(0, 0, 0);
//                    //WS_WriteAll_RGB_REC(0,0,0);
//                    WS_WriteAll_RGB_FRAME_UP(0, 0, 0);
//                    WS_WriteAll_RGB_FRAME(0, 0, 0);
...
//										
//										HAL_Delay(100);
////										Board_Order_info[BOARD_NUMBER].count_t = 0;
										WS_WriteAll_RGB_FRAME_DOWN(0, 0, 0);
                    WS_WriteAll_RGB_REC(0, 0, 0);
                    WS_WriteAll_RGB_FRAME_UP(0, 0, 0);
                    WS_WriteAll_RGB_FRAME(0, 0, 0);
                    WS_CloseAll_Circle();
								...
								else if(Board_Order_info[BOARD_NUMBER].count_t == 5)
								{
//									LED_rectangle_current_REC(0, RED_NUM, 0, 0);	//ÏÔÊ¾½ø¶ÈÌõ
//									WS_WriteAll_RGB_FRAME_DOWN(0, 0, 0);
//                   //WS_WriteAll_RGB_REC(0,0,0);
...
//                  WS_CloseAll_Circle();
									...
									WS_WriteAll_RGB_RECT(RED_NUM,0,0);
            ...
            {
                /*´ý»÷´òÏÔÊ¾*/
                if (Big_Fu_info[BOARD_NUMBER].Hit_LED_state == NO && Big_Fu_info[BOARD_NUMBER].Single_Hit_State == 0
                ...
                /*»÷ÖÐÈ·ÈÏ*/
                if (Big_Fu_info[BOARD_NUMBER].Hit_LED_state == YES && Board_Order_info[BOARD_NUMBER].Twinkle_state == NO
                        && Board_Order_info[BOARD_NUMBER].Board_Work == 1)
                {
            ...
            {
                /*´ý»÷´òÏÔÊ¾*/
                if (Big_Fu_info[BOARD_NUMBER].Hit_LED_state == 0 && Big_Fu_info[BOARD_NUMBER].Single_Hit_State == 0
                        && Board_Order_info[BOARD_NUMBER].Board_Work == 1)
                {
                    ...
                    if (cntt <= 40)
                    {
                        LED_rectangle_current_REC_XIMIE(0, RED_NUM, 0, 0); //Ï¨Ãð¶ÔÓ¦µÄµÆ
                        LED_Blue_rectangle_current(0, RED_NUM, 0, 0);	//¼ýÍ·
                ...
                if (Big_Fu_info[BOARD_NUMBER].Single_Hit_State == YES && Board_Order_info[BOARD_NUMBER].Twinkle_state == NO)
                {
                    //				WS_WriteAll_RGB_REC(RED_NUM,0,0);
										Big_Fu_info[BOARD_NUMBER].Single_Hit_State = YES;
										HAL_Delay(50);
										Big_Fu_info[BOARD_NUMBER].Single_Hit_State = NO;
                    LED_rectangle_current_REC_2(0, RED_NUM, 0, 0);
                    WS_WriteAll_RGB_FRAME_DOWN(255, 0, 0);
                    WS_WriteAll_RGB_FRAME(RED_NUM, 0, 0);
                    //WS_WriteAll_RGB_FRAME(RED_NUM,0,0);/////µ×±ß
                    //WS_WriteAll_RGB_FRAME_JINDU(RED_NUM,0,0);
